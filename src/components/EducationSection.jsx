          ...
          {education.map((edu, idx) => (
            ...
            >
              ...
              <span className="mb-4 md:mb-0 md:mr-6 z-10 select-none flex-shrink-0">
                <span className={`transition-all duration-200 ${tappedIdx === idx ? 'drop-shadow-[0_0_16px_rgba(220,38,38,0.95)]' : 'group-hover:drop-shadow-[0_0_16px_rgba(220,38,38,0.95)]'}`}>{edu.icon}</span>
              </span>
