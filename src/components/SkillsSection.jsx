      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {displayedSkills.map((skill, key) => (
            <motion.div
              key={key}
              className={`relative bg-card/40 backdrop-blur-md p-6 rounded-2xl shadow-lg overflow-hidden group cursor-pointer border border-border/50 ${tappedIdx === key ? 'scale-105 shadow-[0_4px_32px_0_rgba(220,38,38,0.15)]' : ''}`}
