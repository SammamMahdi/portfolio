    ...
    <div className="container mx-auto max-w-5xl">
      ...
      <div className="space-y-10">
        {experiences.map((exp, idx) => (
          <motion.div
            key={idx}
            className="relative flex flex-row items-center bg-card/80 backdrop-blur-md p-8 rounded-2xl shadow-lg overflow-hidden group cursor-pointer"
          ...
          >
            ...
            <span className="relative z-10 select-none ml-4 mr-8">
            ...
            <div className="flex-1">
              ...
              {exp.description && (
                <p className="text-lg text-muted-foreground mt-2">{exp.description}</p>
              )}
            </div>
          </motion.div>
        ))}
